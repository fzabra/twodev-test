...
const Icons = ({ name, ...props }) => {
  const icons = {
    ...
    usergrey: (
      <img src="./images/icons/user-grey.svg" alt="User Icon" width="24px" {...props} />
    ),
    truck: (
      <img src="./images/icons/truck.svg" alt="Truck Icon" {...props} />
    ),
    close: (
      <img src="./images/icons/close-white.svg" alt="Close Icon" width="24px" {...props} />
    ),
    search: (
      <img src="./images/icons/search.svg" alt="Search Icon" width="24px" {...props} />
    ),
